      ...
      <section className="pt-25 pt-1/2 p-8 md:px-24 pt-60 xl:w-3/5 xl:m-auto lg:w-full">
        <div className="lg:flex">
          <div className="lg:pr-20">
            ...
            <p className="text-slate-400 text-sm  py-2 md:text-base">
              I create user-friendly websites and web applicationse that engage
              and delight users. I am well-versed in a variety of programming
            ...
            <p className="text-slate-400 text-sm  py-2 md:text-base">
              ...
              on our projects using MEAN and MERN stack. My role in my previours
              projects is the
              <span className="text-slate-100 ml-1">developer</span> , I
              experienced creating responsive web designs and computer systems
              during my college that work seamlessly across different platforms
              and devices.
            </p>
          ...
          <div className="p-10">
            <img src={TogaPic} className="toga-pic rounded-md" alt="toga pic" />
          </div>
        </div>
      </section>
    </div>
